// NotAllowed.tsx - Admin Re-Authentication page for Direct Auth scope updates
// This is a hidden URL for admin use only (manual entry)
// Flow: Direct Auth (Gmail OAuth) → Redirect to Inbox
// Purpose: Re-authenticate with new OAuth scopes (e.g., contacts.other.readonly)
...
export default function NotAllowedPage() {
  ...
  // Direct Auth OAuth (Gmail with full access)
  const handleSignIn = async () => {
    try {
      setIsLoading(true);
      setError(null);

      console.log("🔐 Starting Direct Auth (Gmail OAuth)...");
      ...
      const checkClosed = setInterval(() => {
        if (popup.closed) {
          console.log("👍 Direct Auth popup closed");
